            ...
            <div className="flex justify-center mt-16">
                <div className="w-2/4 flex">
                    <div className="w-full h-11 justify-start">
                        <strong className="flex text-blue-500">Tarefas criadas <div className="w-7 h-5 ml-3 rounded-xl bg-gray-600 text-white flex items-center justify-items-center "><p className="mx-auto">{tasks.length}</p></div></strong>
                    </div>
