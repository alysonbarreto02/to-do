...
export default function Task() {
    return (
        <div className="flex justify-center">
            <div className="w-2/4 py-4 flex bg-zinc-400 rounded-lg">
                <div className="mr-5 ml-2 h-full justify-center items-center flex "><input type="checkbox" className="rounded-full" /></div>
                <div><p className="text-zinc-100">Fazer algo muito importante pra que aquela coisa muito importante possa acontecer</p></div>
