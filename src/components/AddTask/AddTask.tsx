...
export default function AddTask() {
    ...
    const [moreTask, setMoreTask] = useState(["Top"])
        ...
        <div className="flex-col justify-center items-center -mt-7">
            <div className="flex w-full justify-center">
                <form onSubmit={showMoreTaks} className="flex w-full justify-center">
                    <input value={newTask} onChange={changeNewTask} type="text" placeholder="Adicione uma nova tarefa" className="text-white px-4 w-2/4 h-14 bg-zinc-600 rounded-lg" />
